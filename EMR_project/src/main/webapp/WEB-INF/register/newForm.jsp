...
<body class="container text-center" id="main">
    <h1>No Patient Found, Please Register New Patient</h1>
    <div class="row">
        <div class="col">
        <form:form action="/register/new/patient" method="post" class="container text-center" id="Form" modelAttribute="newPatient">
        ...
        <input type= "submit" class="btn-primary btn" value="Register New Patient"/>
        </form:form>
